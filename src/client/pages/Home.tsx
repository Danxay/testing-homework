  ...
  <div className={bem()}>
    ...
    <div className="row mb-4">
      <div className="col-12 col-md-4 bg-light py-3">
        <h1>Quickly</h1>
        <p className="lead">
          Odio aut assumenda ipsam amet reprehenderit. Perspiciatis qui molestiae qui tempora
          quisquam
        </p>
      </div>
      <div className="col-12 col-md-4 bg-light py-3">
    ...
    <div className="row mb-4">
      <div className="col-12py-3">
        <p>
          Sed voluptatum quis voluptates laudantium incidunt laudantium. Illo non quos eos vel
          ipsa.
          Explicabo itaque est optio neque rerum provident enim qui sed. Corrupti commodi
          voluptatem vero soluta hic.
        </p>
        <p>
          Modi corporis consectetur aliquid sit cum tenetur enim. Sed voluptatum quis voluptates
          laudantium incidunt laudantium.
          Illo non quos eos vel ipsa. Explicabo itaque est optio neque rerum provident enim qui
          sed.
